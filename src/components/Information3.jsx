...
import ImgTool3 from "./ImgTool3";
import Model3 from "./Model_3";

function Information3() {
  return (
    <div id="mainframe" className="information3">
      <div className="content-text">
        <div className="content-texto">
          ...
          <a
            target="_blanck"
            href="https://www.foxconceptstore.com/search?type=product%2Carticle%2Cpage%2Ccollection&q=CASCO+mainframe+pro"
            className="btn-fox"
          >
            Comprar Ahora
          </a>
        ...
        <div className="content-img">
          <ImgTool3 />
          <canvas className="webglllllll"></canvas>
        </div>
      </div>
    </div>
  );
