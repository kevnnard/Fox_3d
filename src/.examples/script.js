...
const fondo = new THREE.TextureLoader();
 fondo.load('img/FOX.mp4', function(texture){
...
function initAudioPlayer() {
    ...
    function playPause() {
        if (audio.paused) {
            audio.play();
            playbtn.style.background = "url(/assets/img/off.png) no-repeat";
        } else {
            audio.pause();
            playbtn.style.background = "url(/assets/img/on.png) no-repeat";
        }
    }
    function mute() {
        if (audio.muted) {
